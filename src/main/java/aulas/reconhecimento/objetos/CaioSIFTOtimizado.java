...
public class CaioSIFTOtimizado {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final MBFImage query = ImageUtilities.readMBF(new File("/Dados/Desenvolvimento/WorkspaceTeste/TesteOpenIMAJ/src/main/resources/livro.jpeg"));

        MBFImage target = ImageUtilities.readMBF(new File("/Dados/Desenvolvimento/WorkspaceTeste/TesteOpenIMAJ/src/main/resources/altar2.jpeg"));
        ...
        RobustHomographyEstimator modelFitter = new RobustHomographyEstimator(0.1, 5000, new RANSAC.BestFitStoppingCondition(),
