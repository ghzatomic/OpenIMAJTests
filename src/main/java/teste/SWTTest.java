...
public class SWTTest {
    public static void main(String[] args) throws Exception {
		...
		final MBFImage image = ImageUtilities.readMBF(new File("/home/ghzatomic/testeocr.png"));
		//image.flipX();

		 //final MBFImage image = new MBFImage(1000, 500, 3);
		 //image.drawText("hello world hello world", 100, 100, new GeneralFont("Time New Roman", 80), 80);
